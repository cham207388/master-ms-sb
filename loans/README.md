...
The **Loans Microservice** handles customer loans (home, personal, vehicle), repayment tracking, total borrowed limits, and outstanding balances for the SecuredBank platform.
...
Manifests: [`k8s/`](k8s/). From repo root: `make k8s-loans`. See [docs/kubernetes.md](../docs/kubernetes.md).
