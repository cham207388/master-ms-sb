...
import com.abcham.cards.dto.ErrorResponseDto;
import com.abcham.cards.dto.ResponseDto;
...
@Tag(name = "CRUD REST APIs for Cards in SecuredBank", description = "CRUD REST APIs in SecuredBank to CREATE, UPDATE, FETCH AND DELETE card details")
@RestController
...
public class CardsController {
    ...
    @Operation(summary = "Create Card REST API", description = "REST API to create new Card inside SecuredBank")
    @ApiResponses({
    ...
    public ResponseEntity<CardsDto> fetchCardDetails(
        ...
        CardsDto cardsDto = iCardsService.fetchCard(correlationId, mobileNumber);
